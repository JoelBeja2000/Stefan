package com.milistajuegos.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.milistajuegos.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.milistajuegos.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
